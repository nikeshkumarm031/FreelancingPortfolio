<script>
    ...
    async function handleSubmit(e) {
        ...
        try {
            ...
            await fetch(
                'https://docs.google.com/forms/d/e/1FAIpQLSdwABrBE9WBGAabv6oNAZMJqWrj69hANhecNGpKU8SIW0imzA/formResponse',
                { method: 'POST', body: formDataObj, mode: 'no-cors' }
            );
...
<section id="contact" class="block md:hidden py-20 lg:py-32 flex flex-col gap-7">
    <!-- MOBILE HEADER -->
    <div class="flex flex-col gap-1 text-center">
        <h6 class="text-large sm:text-xl md:text-2xl text-violet-400 poppins font-semibold">Get Started</h6>
...
<section id="contact" class="hidden md:flex py-20 lg:py-32 flex-col gap-12">
    <!-- DESKTOP HEADER -->
